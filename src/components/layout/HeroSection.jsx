                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="lg:w-1/2 text-center lg:text-left">
                        ...
                        <h1 className="text-5xl lg:text-7xl font-bold text-secondary mb-6 leading-tight">
                            Pure <span className="text-primary relative inline-block">
                                Honey
                    ...
                    <div className="lg:w-1/2 relative flex justify-center">
                        <div className="relative z-10 w-4/5 max-w-md rounded-3xl overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-500">
                            <img
                                src="/images/miel-manzanilla.jpg"
                                alt="Jar of Honey"
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl animate-bounce-slow hidden md:block">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-gray-500 font-bold uppercase">Best Quality</p>
                                        <p className="text-secondary font-bold">Premium Honey</p>
                                    </div>
                                </div>
                            </div>
                        </div>
